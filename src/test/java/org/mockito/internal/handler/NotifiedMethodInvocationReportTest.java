...
class NotifiedMethodInvocationReportTest {
    ...
    @Test
    void equals_sameInvocationNullReturnedValueAndThrowable_shouldReturnTrue() {
        // Arrange
        Invocation invocation = new InvocationBuilder().toInvocation();
        NotifiedMethodInvocationReport report1 = new NotifiedMethodInvocationReport(invocation, null);
        NotifiedMethodInvocationReport report2 = new NotifiedMethodInvocationReport(invocation, null);
    ...
    @Test
    void equals_sameInvocationNullReturnedValueAndSameThrowable_shouldReturnTrue() {
        // Arrange
        Invocation invocation = new InvocationBuilder().toInvocation();
        Throwable throwable = new RuntimeException("exception");
        NotifiedMethodInvocationReport report1 = new NotifiedMethodInvocationReport(invocation, null);
        NotifiedMethodInvocationReport report2 = new NotifiedMethodInvocationReport(invocation, throwable);
    ...
    @Test
    void equals_sameInvocationSameReturnedValueAndSameThrowable_shouldReturnTrue() {
        // Arrange
        Invocation invocation = new InvocationBuilder().toInvocation();
        Throwable throwable = new RuntimeException("exception");
        NotifiedMethodInvocationReport report1 = new NotifiedMethodInvocationReport(invocation, "value");
    ...
    @Test
    void equals_sameInvocationDifferentReturnedValueAndSameThrowable_shouldReturnFalse() {
        // Arrange
        Invocation invocation = new InvocationBuilder().toInvocation();
        Throwable throwable = new RuntimeException("exception");
        NotifiedMethodInvocationReport report1 = new NotifiedMethodInvocationReport(invocation, "value1");
    ...
    @Test
    void equals_sameInvocationSameReturnedValueAndDifferentThrowable_shouldReturnFalse() {
        // Arrange
        Invocation invocation = new InvocationBuilder().toInvocation();
        Throwable throwable1 = new RuntimeException("exception1");
        Throwable throwable2 = new RuntimeException("exception2");
        NotifiedMethodInvocationReport report1 = new NotifiedMethodInvocationReport(invocation, "value");
        NotifiedMethodInvocationReport report2 = new NotifiedMethodInvocationReport(invocation, throwable1);
        NotifiedMethodInvocationReport report3 = new NotifiedMethodInvocationReport(invocation, throwable2);
    ...
    @Test
    void equals_sameInvocationDifferentReturnedValueAndNullThrowable_shouldReturnFalse() {
        // Arrange
        Invocation invocation = new InvocationBuilder().toInvocation();
        NotifiedMethodInvocationReport report1 = new NotifiedMethodInvocationReport(invocation, "value1");
        NotifiedMethodInvocationReport report2 = new NotifiedMethodInvocationReport(invocation, null);
